...
class SubscriptionWeekly extends StatefulWidget {
  @override
  _SubscriptionWeeklyState createState() => _SubscriptionWeeklyState();
}

class _SubscriptionWeeklyState extends State<SubscriptionWeekly> {
  bool _btn = true;
  @override
