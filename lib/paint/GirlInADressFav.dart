...
class GirlInADressFav extends StatefulWidget {
  @override
  _GirlInADressFavState createState() => _GirlInADressFavState();
}

class _GirlInADressFavState extends State<GirlInADressFav> {
  bool _favorite = true;
