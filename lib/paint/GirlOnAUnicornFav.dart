...
class GirlOnAUnicornFav extends StatefulWidget {
  @override
  _GirlOnAUnicornFavState createState() => _GirlOnAUnicornFavState();
}

class _GirlOnAUnicornFavState extends State<GirlOnAUnicornFav> {
  bool _favorite = true;
